	...
	<form id="myform" class="layui-form" action="updatestudent.do"
		...
		<div class="panels_head">
			...
			<button type="button" class="layui-btn layui-btn-danger"
				onclick="window.location.href='${ctx}/student/studentEnlistList.do?pageNo=${page}'"
		...
		<div class="layui-form-item">
			<div class="layui-inline">
				...
				<div class="layui-input-inline" style="width: 130px;">
					<input type="text" hidden="" id=custodian1Relationship
			...
			<div class="layui-inline">
				...
				<div class="layui-input-inline" style="width: 130px;">
					<input type="text" hidden="" name="custodian2Relationship"
			...
			<div class="layui-inline">
				...
				<div class="layui-input-inline" style="width: 130px;">
					<input type="text" name="intentionalSchool" id="intentionalSchool"
						value="${students.intentionalSchool}" 
...
<!-- 			<div class="layui-inline"> -->
<!-- 				<label class="layui-form-label" -->
<!-- 					style="width: 100px; font-size: 14px">创建时间</label> -->
<!-- 				<div class="layui-input-inline" -->
<!-- 					style="width: 400px; margin-top: 8px;"> -->
<%-- 					<fmt:formatDate value="${students.createTime}" --%>
...
<script type="text/javascript">
											...
											$.ajax({
														...
														success : function(res) {
															if (res.code == 0) {
																layer.msg("修改成功!");
																setTimeout(function(){
																	window.location.href = "studentEnlistList.do?pageNo="+${page};
																},1000);
															} else {
	...
	function deleteone(uid,classId){
		layer.confirm('您确认删除该信息么111?',{offset:150,btn:['确认','取消']},function(){
...
// 				alert(JSON.stringify(data));
				if(data.code==0){
					layer.msg('修改成功!');
					setTimeout(function(){
						window.location.href = "${ctx}/student/toupdatestudent.do?studentid="+${students.getStudentId()};
					},1000);
				}else{
					layer.msg(data.msg,{time:3000});
					return;
