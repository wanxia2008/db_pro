     ...
     <div id="box"> 
      <div class="survey" style="margin:0px auto;"> 
       <div id="ctl00_ContentPlaceHolder1_JQ1_divHead" class="surveyhead" style="border: 0px;"> 
        <h1 id="ctl00_ContentPlaceHolder1_JQ1_h1Name" style="position:relative;"> <span id="ctl00_ContentPlaceHolder1_JQ1_lblQuestionnaireName">${paper.hkName}</span> </h1> 
       </div> 
         ...
         <fieldset class="fieldset" id="fieldset1"> 
          ...
          <c:if test="${mulitList != null && fn:length(mulitList)>0}">
           <span style="font-size:16px;font-weight:bold;"> 
            ${multOrder}、多选（每小题${duoxuan}分，共${mulitChoice}小题，总共${mulitscore}分）</span> <br />
          ...
          <div class="div_question" id="div4">
           ...
           <div class="errorMessage"></div>
             ...
             <span style="font-size:16px;font-weight:bold;"> 
             ${judeOrder}、判断（每小题${pduan}分，共${Judge}小题，总共${judgescore}分）</span> <br />
