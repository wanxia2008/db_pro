...
div#errorBox {
	background: url(${ctx}/image/404_bg.png) no-repeat top left;
	width: 943px;
	height: 572px;
	margin: auto;
}
...
<!-- 			<a href="javascript:;" onclick="goIndex();" title="返回首页"> -->
<!-- 				<div class="link" id="home"></div> -->
<!-- 			</a>  -->
			<a href="javascript:;" onclick="goBack();" title="返回上页">
...
<script type="text/javascript">
	function goIndex() {
		top.location.href = "http://localhost:8081/cofC/login.do";
	}
	function goBack() {
		window.history.go(-1);
	}
